...
RSpec.describe Project do
  ...
  it 'has a getter and setter for owner attribute' do
    @project1.owner = "owner Name" # this line would fail if our class did not have a setter method
    expect(@project1.owner).to eq("owner Name") # this line would fail if we did not have a getter or if it did not change the name successfully in the previous line.
  end
